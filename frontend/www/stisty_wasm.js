 ...
 *
 * Note: If reference database is loaded, genotype will be displayed in REF|ALT order
 * (0=REF, 1=ALT). Otherwise, shows raw 23andMe genotype.
 * @param {string} file_content
 * @param {string} rsid
 * @returns {string}
 */
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_5b09fbeec74be75e = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, 118, __wbg_adapter_4);
        return addHeapObject(ret);
    };
